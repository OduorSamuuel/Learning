                ...
                <div class="relative flex items-center justify-between h-16">
                    ...
                    <div class="hidden lg:block lg:ml-6">
                        <div class="flex space-x-4">
                            ...
                            <a href="/services" class="text-gray-900 hover:bg-gray-100 px-3 py-2 rounded-md text-sm font-medium">Services</a>
                            <a href="/contact" class="text-gray-900 hover:bg-gray-100 px-3 py-2 rounded-md text-sm font-medium">Contact</a>
                        </div>
                    </div>
                    <div class="hidden lg:block lg:ml-6">
                        <div class="flex space-x-4">
                            @auth
                                <a href="{{ url('/profile') }}" class="text-gray-900 hover:bg-gray-100 px-3 py-2 rounded-md text-sm font-medium">Dashboard</a>
                            @else
